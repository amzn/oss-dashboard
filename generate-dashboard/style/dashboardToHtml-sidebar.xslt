      ...
      <body class="inverse">
        ...
        <div class="well">
          ...
          <ul id="tabs" class="nav nav-tabs nav-pills">
            <li class="active"><a href="#organization" data-toggle="tab">Organization</a></li>
            <li><a href="#repos" data-toggle="tab">Repositories</a></li>
            <li><a href="#triage" data-toggle="tab">Triage</a></li>
...
<tr><td style="vertical-align:top; padding-right: 2em;">
           <ul id="tabs" class="nav nav-tabs nav-stacked nav-pills">
...
<td>
          <div id="triagetabcontent" class="tab-content">
...
<td>
          <div id="usermanagement-tabcontent" class="tab-content">
